...
VALUES
  ...
  ('Arcade Fire',
   ...
   '2016-06-25 20:00:00', 'Zaterdag',
   'spotify:artist:3kjuyTCjPG1WMFCiyc5IuB'),
  ('The Strokes',
   'The Strokes are an American rock band formed in New York City in 1998, consisting of Julian Casablancas (lead vocals), Nick Valensi (guitar, keyboard, backing vocals), Albert Hammond, Jr. (rhythm guitar, keyboard, backing vocals), Nikolai Fraiture (bass) and Fabrizio Moretti (drums, percussion).<br />
   <br />
   ...
   <br />
    After its members embarked on a variety of side projects, the band regrouped for a fifth album, Comedown Machine, released on March 26, 2013. The Strokes have sold over 5 million albums to date.',
   '2016-06-26 00:30:00', 'Zaterdag',
  ...
  ('The Decemberists',
   ...
   '2016-06-26 16:00:00', 'Zondag',
   'spotify:artist:7ITd48RbLVpUfheE7B86o2');

INSERT INTO pictures (show_id, extension)
VALUES
  ('1', 'jpg'),
  ('1', 'jpg'),
  ('1', 'jpg'),
